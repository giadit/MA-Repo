...
COP, eta = eff_calc(125, TRY=True)

epc_storage = economics.annuity(capex=3,n=40,wacc=0.05)
epc_HP = economics.annuity(capex=628, n=30,wacc=0.05)
...
year_index = create_time_index(year=2045, number=len(pv_data)-1)
