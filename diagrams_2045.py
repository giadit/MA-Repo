...
elc_file = "results/el_bus_recalc_PTES_2045.csv"
...
grid_costs = pd.read_csv("data/grid_costs_2045.csv")
grid_costs[grid_costs["End User Price [EUR/kWh]"] <= 0] = 0
pv_data = fetch_pv_data(2045)

date_range = pd.date_range(start='2045-01-01', end='2045-12-31 23:00:00', freq='h')
grid_costs.set_index(date_range)
...
# Set axis limits
plt.xlim(pd.Timestamp('2045-01-01'), pd.Timestamp('2045-12-31 23:00:00'))
