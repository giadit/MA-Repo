...
storage_file = "results/storage_pilot.csv"
HP_file = "results/HP_pilot.csv"
ORC_file = "results/ORC_pilot.csv"
thdemand_file ="results/thdemand_pilot.csv"
el_file ="results/el_pilot.csv"
elc_file = "results/el_bus_recalc_PTES_pilot.csv"
...
print(el_bus["to excess"].sum())import matplotlib.pyplot as plt
import numpy as np
import pandas as pd
from matplotlib.dates import DateFormatter
from pv_data import fetch_pv_data
